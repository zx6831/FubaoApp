...
class PhoneLoginPage extends StatefulWidget {
  ...
  final Future<bool> Function(String phone, String code, AppRole role)
      onVerifyCode;
              ...
              child: Column(
                ...
                children: [
                  ...
                  SegmentedButton<AppRole>(
                    ...
                    selected: {_role},
                    onSelectionChanged: _codeRequested
                        ? null
                  ...
                  if (_codeRequested) ...[
                    ...
                    if (widget.testCode != null)
                      Text('调试验证码：${widget.testCode}',
                          style:
                              const TextStyle(color: FubaoColors.mintStrong)),
                  ],
                  ...
                  FilledButton(
                    ...
                    child: Text(
                        _busy ? '请稍候…' : (_codeRequested ? '登录' : '获取验证码')),
                  ),
                  if (_codeRequested)
                    TextButton(
                      onPressed: _busy
